...
function BSFigure() {
  return (
    <FigureWrapper caption="貸借対照表の略図">
      ...
      <Box sx={{ border: 2, borderColor: 'text.primary' }} display="flex" width={1} height={280}>
        <Box
          bgcolor={({ palette }) => alpha(palette.info.main, palette.action.hoverOpacity)}
          sx={{
            borderRight: 2,
        ...
        <Box sx={{ width: 1 / 2 }} display="flex" flexDirection="column" flexGrow={1}>
          <Box
            bgcolor={({ palette }) => alpha(palette.error.main, palette.action.hoverOpacity)}
            sx={{
              borderBottom: 2,
              borderColor: 'text.primary',
            }}
          ...
          <Box
            ...
            flexDirection="column"
            flex={1}
            bgcolor={({ palette }) => alpha(palette.success.main, palette.action.hoverOpacity)}
          >
